...
import com.shawee.hackaton.exceptions.ExistingEmailException;
import com.shawee.hackaton.repositories.RoleRepository;
import com.shawee.hackaton.repositories.UserRepository;
import com.shawee.hackaton.security.JwtBlacklist;
...
public class UserServiceImpl implements UserService, UserDetailsService {
	...
	public User save(UserRequestDTO userRequestDTO) throws EntityNotFoundException {
		...
		Role role = roleRepository.findByName("ROLE_ADMIN")
				.orElseThrow(() -> new EntityNotFoundException("Role not found for "));
		user.addRole(role);
